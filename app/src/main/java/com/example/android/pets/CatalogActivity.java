...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private final int PET_CURSOR_LOADER = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(PET_CURSOR_LOADER, null, this);
    }
    ...
    void insertPet()
    {
        ...
        Uri uriResult = getContentResolver().insert(PetContract.PetEntry.CONTENT_URI, values);

        Log.d("DATABASE", "URI result: " + uriResult);
    }
